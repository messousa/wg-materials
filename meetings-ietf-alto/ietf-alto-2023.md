...
- Richard <> Qin:
	- Discussion about: "Multi domain contact use case": the sparsity of information (issue#1), ambiguity of information(issue#2)
		- Scenario 1:
		- Scenario 2: Multi-Domain Settings (2 ALTO servers in 2 different domains)

- Jordi <> Richard:
	- The importance of computing information. Not only nano-info can be collected but also Compute information.
